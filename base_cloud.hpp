...
public:
    ...
    virtual std::unique_ptr<CurlEasyHandle> create_file_update_handle(const std::string&, const std::filesystem::path&, const std::string&, const std::string&) = 0;
    virtual std::unique_ptr<CurlEasyHandle> create_file_download_handle(const std::string&, const std::filesystem::path&) = 0;
    virtual std::unique_ptr<CurlEasyHandle> create_metadata_update_handle(const std::string&, const std::string&, const std::string& name = "") = 0;
